...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log(`Proxying match-skills request to Python service: ${pythonServiceUrl}/match-skills/`);

    const response = await fetch(`${pythonServiceUrl}/match-skills/`, {
      method: 'POST',
      body: forwardData,
    });
    ...
    console.error('Error in proxy route /api/match-skills:', error);
